...
$requiredAdminMarkers = [
    ...
    'Cannot delete a position assigned to active user records.',
    'bx_admin_assert_position_readback',
    "UPDATE project_user_position SET position_code = ?, position_name = ?, group_key = ?",
    "INSERT INTO project_user_position (position_key, project_key, position_code, position_name, group_key",
    ...
    "position_count",
    "'positions' => \$isAdmin ? bx_admin_payload_rows",
