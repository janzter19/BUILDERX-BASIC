...
$adminWriterSource = file_get_contents($root . '/scripts/firebase-admin-project-user-write.mjs');
$registrySource = file_get_contents($root . '/scripts/firebase-mysql-sync/registry.mjs');
$firestoreRules = file_get_contents($root . '/firestore.rules');

if (!is_string($foundationSource) || !is_string($adminSource) || !is_string($frontendSource) || !is_string($scriptSource) || !is_string($adminWriterSource) || !is_string($registrySource) || !is_string($firestoreRules)) {
