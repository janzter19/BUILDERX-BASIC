...
async function main() {
  ...
  const data = {
    ...
    user_avatar_uploaded_at: nullable(profile.user_avatar_uploaded_at),
    ...
    user_last_login_at: nullable(profile.user_last_login_at),
    ...
    user_last_logout_at: nullable(profile.user_last_logout_at ?? existing.user_last_logout_at),
    ...
    user_password_reset_at: nullable(profile.user_password_reset_at ?? existing.user_password_reset_at),
    user_activated_at: nullable(profile.user_activated_at ?? existing.user_activated_at),
    user_deactivated_at: nullable(profile.user_deactivated_at ?? existing.user_deactivated_at),
    user_locked_at: nullable(profile.user_locked_at ?? existing.user_locked_at),
